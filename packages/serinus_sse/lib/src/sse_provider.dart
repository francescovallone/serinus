...
abstract class SseProvider extends Provider {
  ...
  SseProvider(this.path);

  /// The [onMessage] method will be called when a message from the client is received through a POST request.
  ///
  ...
  Future<void> onMessage(String clientId, String data, SseContext context);
