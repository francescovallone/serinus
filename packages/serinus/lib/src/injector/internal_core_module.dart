...
import '../microservices/microservices_module.dart';
...
class InternalCoreModule extends Module {
  ...
  InternalCoreModule(GraphInspector inspector, bool microservicesEnabled)
    : super(
        imports: [
          InspectorModule(inspector),
          MiddlewareModule(inspector),
          if (microservicesEnabled) MicroservicesModule(),
        ],
