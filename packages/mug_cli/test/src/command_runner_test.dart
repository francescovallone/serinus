...
import 'package:mug_cli/src/command_runner.dart';
...
void main() {
  group('MugCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late MugCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = MugCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = MugCliCommandRunner();
