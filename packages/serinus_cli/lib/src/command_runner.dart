...
/// ```
/// {@endtemplate}
class SerinusCliCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro serinus_cli_command_runner}
  SerinusCliCommandRunner({
    Logger? logger,
    ...
    addCommand(AgentsCommand(logger: _logger));
  }
