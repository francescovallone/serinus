...
MasonBundle generateServiceTemplate(String type, String name){
  return MasonBundle.fromJson({
    'files': [
      {
        'path': '${name}_$type.dart',
        'data': 'aW1wb3J0ICdwYWNrYWdlOnNlcmludXMvc2VyaW51cy5kYXJ0JzsKCmNsYXNzIHt7bmFtZS5wYXNjYWxDYXNlKCl9fSBleHRlbmRzIFNlcmludXNQcm92aWRlcnsKCn0=',
        'type': 'text'
      },
    ],
    'name': 'create_service',
