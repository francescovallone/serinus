                ...
                <div class="grid md:grid-cols-2">
                  <div class="aspect-video md:aspect-auto overflow-hidden">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-6">
                      <span :class='`tag text-xs ${categoryColors[featuredPost.tags[0]] || "bg-muted-foreground/10 text-muted-foreground"}`'>
                        {{featuredPost.tags[0]}}
                      </span>
                ...
                >
                  ...
                  <div class="p-6 flex flex-col flex-grow">
                    <div class="flex items-center justify-between mb-4">
                      <span :class='`tag text-[10px] ${categoryColors[post.tags[0]]}`'>
                        {{post.tags[0]}}
                      </span>
