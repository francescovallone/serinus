...
<template>
	<svg width="688" height="400" xmlns="http://www.w3.org/2000/svg">
		<rect x="50" y="50" width="150" height="60" class="box stroke" rx="8" ry="8"/>
    	<rect x="45" y="45" width="160" height="70" class="box stroke" rx="12" ry="12" style="stroke-width: 1;"/>
		...
		<rect x="460" y="160" width="150" height="60" class="box" rx="12" ry="12"/>
		...
		<rect x="50" y="160" width="150" height="60" class="box stroke" rx="12" ry="12"/>
		...
		<rect x="50" y="270" width="150" height="60" class="box" rx="12" ry="12"/>
		...
		<rect x="460" y="270" width="150" height="60" class="box" rx="12" ry="12"/>
